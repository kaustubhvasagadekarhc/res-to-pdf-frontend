  ...
  return (
    <div className="p-8 max-w-7xl mx-auto font-sans text-slate-900">
      ...
      <div className="flex items-center mb-10">
        <h1 className="text-2xl font-bold text-slate-800 mr-3">
          Activity Logs
        </h1>
        <Button
          variant="ghost"
                      ...
                      >
                        ...
                        <div className="pl-2 pt-0.5 pb-2">
                          <div className="flex flex-wrap items-start gap-2 text-sm leading-6">
                            {/* Avatar */}
                            <div
                              className={`w-6 h-6 rounded-full flex items-center justify-center font-bold text-[10px] shadow-sm ${userColor.bg} ${userColor.text} ring-2 ring-white`}
                            >
                            ...
                            <div className="flex-1">
                              ...
                              <div className="text-xs lg:flex items-center gap-1 mb-1">
                                <div className="inline lg:flex lg:items-center lg:gap-1">
                                ...
                                <span className="block lg:inline text-slate-900 mt-0.5 lg:mt-0">
